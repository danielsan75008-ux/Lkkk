...
RunService.RenderStepped:Connect(function()
    ...
    -- Screen Stretch — aplicado POR ÚLTIMO no frame, após aimbot e ESP
    -- O aimbot já rodou acima e leu o CFrame limpo, então não há conflito
    if getgenv()._hub_stretchOn then
...
-- Screen Stretch
-- Método idêntico ao script de referência:
-- Camera.CFrame * CFrame.new(0,0,0, 1,0,0, 0,STRETCH,0, 0,0,1)
-- Aplicado DENTRO do render loop principal, APÓS o aimbot,
-- então o aimbot lê sempre o CFrame limpo e o stretch é o último passo.
getgenv()._hub_stretchVal = 0.65
getgenv()._hub_stretchOn  = false

local function startScreenStretch()
    getgenv()._hub_stretchOn = true
end
...
do
    ...
    TabUseful:Toggle({
        ...
        Desc  = "Estica a tela (mesmo método do script original — 0.65)",
        Value = false,
        Callback = function(v)
